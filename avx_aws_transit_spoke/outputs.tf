...
output "transit_gateway_peering_attributes" {
  ...
  value = var.peer_transit_gateways ? {
    transit_gateway_name1 = aviatrix_transit_gateway_peering.transit_gateway_peering[0].transit_gateway_name1
    transit_gateway_name2 = aviatrix_transit_gateway_peering.transit_gateway_peering[0].transit_gateway_name2
  } : {}
}
